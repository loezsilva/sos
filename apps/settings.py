...
CUTUCAO_PUBLICO_MAX_POR_MINUTO = config(
    'CUTUCAO_PUBLICO_MAX_POR_MINUTO', default=3, cast=int
)
CUTUCAO_PUBLICO_COOLDOWN_SEGUNDOS = config(
    'CUTUCAO_PUBLICO_COOLDOWN_SEGUNDOS', default=15, cast=int
)
CUTUCAO_PUBLICO_CONFIAR_X_FORWARDED_FOR = config(
    'CUTUCAO_PUBLICO_CONFIAR_X_FORWARDED_FOR', default=False, cast=bool
)
